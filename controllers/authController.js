...
const getHashedToken = require('../utils/getHashedToken');
...
const createSendToken = (user, req, res, statusCode, data) => {
...
exports.signUp = catchAsync(async (req, res, next) => {
  ...
  createSendToken(newUser, req, res, 201, { user: newUser });
});
...
exports.login = catchAsync(async (req, res, next) => {
  ...
  createSendToken(user, req, res, 200, undefined);
});
